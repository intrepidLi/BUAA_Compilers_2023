...
public class FunctionInt {
    ...
    public FunctionInt(String name, boolean isBuiltIn, Type type, Function parent, Type... paramType) {
        this.name = "@" + name;
    ...
    public FunctionInt(String name, boolean isBuiltIn, Type type, ArrayList<Type> paramTypes) {
        this.name = "@" + name;
        this.isBuiltIn = isBuiltIn;
        funcParams = new ArrayList<>();
        basicBlocks = new ArrayList<>();
